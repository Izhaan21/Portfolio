      ...
      <div className="hero-content">
        ...
        <div className="hero-bottom-bar hero-bottom-bar-custom">
          ...
          <div className="hero-social-block">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hero-social-link" title="Instagram">
              <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 18, height: 18 }}>
            ...
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hero-social-link" title="Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 18, height: 18 }}>
